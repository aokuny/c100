...
public class CarInfoResponse{
    ...
    private String CredentislasNum;//证件号码
    ...
    public RelaPeopleResponse getRelaPeopleResponse() {
        return relaPeopleResponse;
    }

    public void setRelaPeopleResponse(RelaPeopleResponse relaPeopleResponse) {
        this.relaPeopleResponse = relaPeopleResponse;
    }
