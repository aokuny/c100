...
/**
 * Created by fengwen on 2016/5/31.
 */
public class HebaoCopyInfoPage extends BasePage {

    private static Logger logger = Logger.getLogger(HebaoCopyInfoPage.class);

    public HebaoCopyInfoPage(int type) {
        super(type);
    }
